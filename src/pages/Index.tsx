...
const features = [
  { icon: FileText, title: 'Easy Order Submission', desc: 'Submit orders in minutes with our streamlined form.' },
  ...
  { icon: Headphones, title: 'Dedicated Support', desc: 'Our procurement team assists you from order to delivery.' },
];
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg opacity-90 mb-8 max-w-md mx-auto">
            Register your company account and start submitting orders today.
          </p>
