  ...
  return (
    <PublicLayout>
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        <h1 className="font-display text-3xl font-bold mb-2">Submit Order</h1>
        <p className="text-muted-foreground mb-8">Fill in the details below to submit an order for industrial spare parts.</p>
